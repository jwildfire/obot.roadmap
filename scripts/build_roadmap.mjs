...
Roadmap project</a>.</p>
<p class="meta">For what has actually shipped — releases, milestones, open work, and PR activity
per repo — see <a href="status.html">package status</a>. For the narrative view —
accomplishments, status by workstream, and proposed next steps — see the
<a href="reports/executive-overview-2026-07-21/">executive overview (2026-07-21)</a> and the
<a href="reports/">reports index</a>.</p>
${sections}
${auditLogHtml}
<script>
