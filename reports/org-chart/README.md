...
- As of: the morning of Sunday 17 August 2026. The page carries its own as-of stamp and a staleness section; trust those over this file.
...
- Claim-checking: load-bearing claims were verified against the sweep log, the delivery record, and the cited issues; the lid-closed figure uses the measured 11h53m ("nearly twelve hours") rather than the rounded "thirteen hours" that appears in some retellings.
