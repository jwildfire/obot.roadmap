...
|---|---|---|---|---|
| [Workers that finish into nothing](2026-08-15-worker-closeout-check/) | 2026-08-15 | [#73](https://github.com/jwildfire/obot.roadmap/issues/73) | [#185](https://github.com/jwildfire/obot.roadmap/discussions/185) | Awaiting @jwildfire — W1–W4 (D0015.1–.4): the worker closeout contract (every worker finishes into a release PR, a question, or a config request), how the Navigator detects a closeout, and how to attribute a change to an agent when every write carries the same bot identity |
