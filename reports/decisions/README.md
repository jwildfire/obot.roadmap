...
| [Bringing the autonomy goal up to date](2026-08-17-goal-73-up-to-date/) | 2026-08-17 | [#73](https://github.com/jwildfire/obot.roadmap/issues/73) | [#228](https://github.com/jwildfire/obot.roadmap/discussions/228) | Partially decided 2026-08-17 — G3 and G4 (D0020.3–.4) answered; G1 and G2 still his. On the orphaned history he overruled this page and the operating officer both, taking neither a start line nor a full backfill: "i'm fine if some orphans stay orphaned, but fix the ones we can. Let's tag true orphans with a label. and just add comments on requirements that get retroactive updates. Again, we're pushing for transparency and continuous improvement. not perfection." Delivered the same morning and checked against GitHub rather than an exit code — 51 items attached and re-read to confirm the link changed, 146 labelled as settled history across seven repositories, 28 requirements told on the issue that they had gained a child after the fact, and the check taught to stop counting a labelled orphan; the count across all recorded history fell from 197 to 1, and the survivor is eight minutes of real drift ([#233](https://github.com/jwildfire/obot.roadmap/issues/233), [obot.agent#164](https://github.com/jwildfire/obot.agent/pull/164)). On the title he took "Increase Autonomy" as recommended, with the loop framing in the goal's opening sentence rather than in the name, and ruled out the option naming schedules — relayed rather than quoted, and marked so on the page. Applying it is his: the new title and the proposed body are posted to [#73](https://github.com/jwildfire/obot.roadmap/issues/73) as a comment, because the goal's own text reserves its direction to him. Still open: the rewritten body (G1) and whether the five workstreams are the right grouping (G2) — the five labels are on the goal's open requirements now (the 37 this page sorted, plus 10 filed since), applied at the operating officer's direction under requirement [#226](https://github.com/jwildfire/obot.roadmap/issues/226) rather than on an answer of his, and reversible in one command |
