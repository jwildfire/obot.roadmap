...
- 27 changes applied (§1 of the page). Issue closes were deliberately excluded: they are a state change with consequences, and agent closes are hook-blocked in this workspace by design.
